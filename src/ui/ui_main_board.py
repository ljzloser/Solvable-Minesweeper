...
"}")
        ...
        self.action_Arbiter_CSV = QtWidgets.QAction(MainWindow)
        self.action_Arbiter_CSV.setText("Arbiter CSV")
        self.action_Arbiter_CSV.setIconText("Arbiter CSV")
        self.action_Arbiter_CSV.setToolTip("Arbiter CSV")
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        self.action_Arbiter_CSV.setFont(font)
        self.action_Arbiter_CSV.setObjectName("action_Arbiter_CSV")
        ...
        self.action_meta_bin = QtWidgets.QAction(MainWindow)
        self.action_meta_bin.setText("meta.bin")
        self.action_meta_bin.setIconText("meta.bin")
        self.action_meta_bin.setToolTip("meta.bin")
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        self.action_meta_bin.setFont(font)
        self.action_meta_bin.setObjectName("action_meta_bin")
        self.menu_5.addAction(self.action_Arbiter_CSV)
        self.menu_5.addAction(self.action_meta_bin)
