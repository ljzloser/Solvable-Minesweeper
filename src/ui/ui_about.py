...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 578, 53))
        ...
        self.label_race_label = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(0, 30, 578, 122))
        ...
        self.label_race_label_3 = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.horizontalLayout_2.addWidget(self.label_race_label_3)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "Copyright © 2020-2025 王嘉宁, 版权所有"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("Form", "贡献者"))
